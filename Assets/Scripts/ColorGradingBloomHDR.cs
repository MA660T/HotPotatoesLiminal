...
//[ExecuteInEditMode]
public class ColorGradingBloomHDR : MonoBehaviour
{
    ...
    public Material[] hdrObjectMaterial;
    public float upmostLuminanceGChannel = 15.0f;
    public float exposure = 0.2f;
    public Color bloomColor = Color.white;
    public float globalBloomStrength = 1.0f;
    ...
    void OnEnable()
    {
        ...
        dualFilterBloomMat = new Material(Shader.Find("Custom/DualFilterBloomHDR"));
    ...
    void Start()
    {
        foreach(Material theMat in hdrObjectMaterial)
        {
            theMat.SetFloat("_UpmostLuminance", upmostLuminanceGChannel);
            theMat.SetFloat("_Exposure", exposure);
        }

        dualFilterBloomMat.SetFloat("_UpmostLuminance", upmostLuminanceGChannel);
        dualFilterBloomMat.SetFloat("_Exposure", exposure);
